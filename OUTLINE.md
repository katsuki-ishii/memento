...
- **ライフグリッド**: 寿命年数×52週のセル表示。JST・週開始は月曜。現在週ハイライト、イベント重畳。
- **イベント記録**: 週セルからタイトル/メモ/感情スコアをCRUD。
- **進捗サマリー**: 記録済み週数、残り寿命（週・日・%）を提示。
...
4. **ダッシュボードを見る**: 寿命×52週グリッドで現在週を確認し、イベント有無を色分け表示。
5. **イベントを記録・編集**: 週セルをクリックしてイベントを追加/更新/削除。進捗サマリーで残り時間を把握。
